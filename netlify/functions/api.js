// This file was renamed from server.js to api.js for Netlify routing
"use strict";
...
const sessionConfig = {
    ...
    cookie: {
        ...
        httpOnly: true,
        sameSite: 'none', // Netlify/production cross-origin requires 'none'
...
const resetPasswordRoutes_1 = __importDefault(require("./resetPasswordRoutes"));
app.use(resetPasswordRoutes_1.default);
// Salon routes
...
app.get('/api/reviews', async (req, res) => {
    try {
        ...
        FROM reviews r
        JOIN users u ON r.user_id = u.id
        WHERE r.salon_id = ${parseInt(salonId)}
        ORDER BY r.created_at DESC
      `;
        }
        else {
...
app.get("/api/search/suggestions", async (req, res) => {
    ...
    `;
        ...
        const results = [...salonResults, ...serviceResults]
            ...
            if (a.type === 'salon' && b.type === 'service')
                return -1;
            if (a.type === 'service' && b.type === 'salon')
                return 1;
            return 0;
        })
