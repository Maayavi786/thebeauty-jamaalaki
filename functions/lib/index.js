...
exports.generateDailyBookingReport = exports.updateSalonRating = exports.updateBookingStatus = exports.sendBookingConfirmation = exports.sendWelcomeEmail = exports.setUserRole = void 0;
...
exports.sendWelcomeEmail = functions.auth
    ...
    try {
        ...
        const displayName = (userData === null || userData === void 0 ? void 0 : userData.fullName) || email;
        if (!email) {
        ...
        const mailOptions = {
          ...
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eaeaea; border-radius: 5px;">
            ...
            <div style="background-color: #f9f9f9; padding: 15px; border-radius: 5px; margin: 20px 0;">
              ...
              <p><strong>Salon:</strong> ${(salonData === null || salonData === void 0 ? void 0 : salonData.name_en) || 'Unknown'}</p>
              <p><strong>Service:</strong> ${(serviceData === null || serviceData === void 0 ? void 0 : serviceData.name_en) || 'Unknown'}</p>
            ...
            <p>Phone: ${(salonData === null || salonData === void 0 ? void 0 : salonData.phone) || 'N/A'}</p>
            <p>Email: ${(salonData === null || salonData === void 0 ? void 0 : salonData.email) || 'N/A'}</p>
...
exports.updateBookingStatus = functions.https.onCall(async (data, context) => {
    ...
    if (!context.auth) {
        throw new functions.https.HttpsError("unauthenticated", "User must be authenticated to update booking status.");
    }
    const { bookingId, newStatus } = data;
    if (!bookingId || !newStatus) {
        throw new functions.https.HttpsError("invalid-argument", "Booking ID and new status are required.");
    }
    // Valid status values
    ...
    try {
        ...
        if (context.auth.uid !== salonData.owner_id &&
            context.auth.uid !== bookingData.user_id) {
            throw new functions.https.HttpsError("permission-denied", "User does not have permission to update this booking.");
        }
        // Only allow customers to cancel their bookings
        if (context.auth.uid === bookingData.user_id &&
            newStatus !== "cancelled") {
            throw new functions.https.HttpsError("permission-denied", "Customers can only cancel bookings.");
        }
        ...
        const mailOptions = {
          ...
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eaeaea; border-radius: 5px;">
            ...
            <p>Hi ${(userData === null || userData === void 0 ? void 0 : userData.fullName) || email},</p>
            <p>Your booking status has been updated to: <strong>${newStatus.charAt(0).toUpperCase() + newStatus.slice(1)}</strong></p>
        ...
        throw new functions.https.HttpsError("internal", "Error updating booking status.");
    }
});
// Function to update salon rating when a new review is created
exports.updateSalonRating = functions.firestore
...
exports.generateDailyBookingReport = functions.pubsub
    ...
    try {
        ...
        const formattedDate = (0, date_fns_1.format)(yesterday, "yyyy-MM-dd");
        ...
        bookingsSnapshot.forEach((doc) => {
            ...
            salonBookings[salonId].push(Object.assign({ id: doc.id }, booking));
        });
        ...
        for (const [salonId, bookings] of Object.entries(salonBookings)) {
            ...
            <tr>
              ...
              <td style="padding: 8px; border-bottom: 1px solid #ddd;">${booking.status.charAt(0).toUpperCase() + booking.status.slice(1)}</td>
            </tr>
          `;
            }
            // Send email report
            ...
            <div style="font-family: Arial, sans-serif; max-width: 800px; margin: 0 auto; padding: 20px; border: 1px solid #eaeaea; border-radius: 5px;">
              ...
              <p>Hi ${(ownerData === null || ownerData === void 0 ? void 0 : ownerData.fullName) || ownerEmail},</p>
